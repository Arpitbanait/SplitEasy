...
import { u as useAuth, a as api } from "./router-CEMUKAFA.mjs";
import { A as AppShell, f as formatMoney, C as Card, c as CardContent, S as Skeleton } from "./card-T6n13wHJ.mjs";
...
function BalancesPage() {
  ...
  const currentUser = user?.full_name?.trim().toLowerCase() ?? "";
