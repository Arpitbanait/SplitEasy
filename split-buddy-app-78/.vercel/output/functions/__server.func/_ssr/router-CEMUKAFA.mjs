...
const appCss = "/assets/styles-CJ2DBOqy.css";
...
const $$splitComponentImporter$a = () => import("./auth-BxK-ceI9.mjs");
...
const $$splitComponentImporter$7 = () => import("./settings-WCOZJbk8.mjs");
const Route$7 = createFileRoute("/_authenticated/settings")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./payments-D27rug_T.mjs");
const Route$6 = createFileRoute("/_authenticated/payments")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./notifications-AYGzURV-.mjs");
const Route$5 = createFileRoute("/_authenticated/notifications")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./groups-BD7Pfrv2.mjs");
const Route$4 = createFileRoute("/_authenticated/groups")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-NL849Mkb.mjs");
...
const $$splitComponentImporter$2 = () => import("./balances-Cz6R57wl.mjs");
const Route$2 = createFileRoute("/_authenticated/balances")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./groups._groupId-Bc3ThNfN.mjs");
const Route$1 = createFileRoute("/_authenticated/groups/$groupId")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./expenses.new-AW7Udk9J.mjs");
